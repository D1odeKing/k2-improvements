...
class PrinterInstaller:
    ...
    def run_installation(self, components=None):
        ...
        if components is None:
            components = ['ustreamer', 'overrides', 'cleanup', 'resonance', 'timelapse', 'mainsail']
...
def main():
    ...
    parser.add_argument("--components", nargs="+", 
                       choices=['ustreamer', 'kamp', 'overrides', 'cleanup', 'resonance', 'timelapse', 'timelapseh264', 'mainsail'],
